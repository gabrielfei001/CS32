...
int main() {
    ...
    test1.dumpWordsSortedByWord(foo);
    std::ostringstream bar;
    test1.dumpWordsSortedByOccurence(bar);
    test1.addAllWords("words words ding ding a");
    assertEquals(test1.getTotalWords(), 10, "at", __LINE__);
    assertEquals(test1.getWordCount("words"), 4, "at", __LINE__);
    assertEquals(test1.getWordCount("ding"), 2, "at", __LINE__);
    assertEquals(test1.getWordCount("a"), 2, "at", __LINE__);
}